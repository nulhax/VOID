...
// Member Methods
	...
	public void Update()
	{
		...
		{	
			...
			{
				CGame.Ship.GetComponent<CShipFacilities>().CreateFacility(m_FacilitySelected, GetComponent<CFacilityInterface>().Id, m_LocalExpansionPortIdSelected, m_OtherExpansionPortIdSelected);
