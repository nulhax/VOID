...
public class CFacilityTurrets : CNetworkMonoBehaviour
{
	...
	public List<GameObject> GetAllUnmountedTurrets()
	{
		var unmountedTurrets =
			...
			where tn.GetComponent<CTurretNodeInterface>().IsTurretInstalled && !tn.GetComponent<CTurretNodeInterface>().AttachedTurret.GetComponent<CTurretController>().IsMounted
