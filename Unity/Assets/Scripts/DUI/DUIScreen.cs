...
public class DUIScreen : MonoBehaviour
{
    ...
    //// Member Methods
    //public void Initialise(string _mainViewXML)
    //{
    //    // Get the text asset of the xml to load
    //    TextAsset mainViewXML = (TextAsset)Resources.Load("XMLs/DUI Consoles/mainviews/" + _mainViewXML + ".xml", typeof(TextAsset));

    //    // Load the XML reader and document for parsing information
    //    XmlTextReader xReader = new XmlTextReader(new StringReader(mainViewXML.text));
